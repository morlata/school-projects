...
<position> : general | scientist | drug dealer | terrorist
<insane-plan> : <wants> <something-bad> by <something-absurd>
<wants> : plans to | schemes to | plots to | attempts to
<something-bad> : take over the world | start world war 3 | kill Bond | mess up Bond's hair | lower England's standard of living
...
<someone-important> : the President. | the Prime Minister. | the only Russian leader who believes in peace. | Geraldo Rivera.
...
<taken> : kidnapped by ninjas | drugged by the female interest | siezed by commandos | overwhelmed by an army of terrorists | betrayed by a double-agent
<bizarre-threat> : thrown to sharks. | chained to a bomb. | suspended over a bottomless chasm. | dropped out of an airplane. | fed to pirannahs. | tied in front of a giant laser. | tied to a speedboat. | forced to watch 'Geraldo!'
...
<gadget> : wristwatch-laser. | Bat Gas. | inflatable submarine. | fold-out helicopter. | Vax 8800.
...
<something-dangerous> : the Bad Guy's secret base | Geraldo Rivera | SMERSH headquarters | the Kremlin